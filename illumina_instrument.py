...
FCIDs = {"C[A-Z,0-9]{4}ANXX$": (["HiSeq 1500", "HiSeq 2000", "HiSeq 2500"], "High Output (8-lane) v4 flow cell"),
         "C[A-Z,0-9]{4}ACXX$": (
         ["HiSeq 1000", "HiSeq 1500", "HiSeq 2000", "HiSeq 2500"], "High Output (8-lane) v3 flow cell"),
        ...
        with gzip.open(fastq) as f:
            ...
            if len(line) > 0:
                if line[0] == "@":
                    ...
                    sys.exit("Incorrectly formatted first read in FASTQ file: %s" % fastq)
...
if __name__ == '__main__':
    ...
    message, sequencers = sequencer_detection_message([fastq_files])
